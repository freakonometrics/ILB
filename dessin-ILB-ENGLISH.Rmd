...
```{r Figure-ILB-4-4, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=1:2)
...
```{r Figure-ILB-4-2, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=1:2)
plot(0:1,0:1,col="grey",xlab="False Positive Rate",
     ylab="True Positive Rate",type="l")
...
```{r Figure-ILB-4-8, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=1:2)
plot(0:1,0:1,col="grey",xlab="False Positive Rate",
     ylab="True Positive Rate",type="l")
RC = Vectorize(function(s) roc.curve(s)$v)((0:1000)/1000)
...
```{r Figure-ILB-4-10, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=1:2)
...
```{r Figure-ILB-4-13, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
...
```{r Figure-ILB-3-3-12, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
library(ellipse)
...
```{r Figure-ILB-3-3-34, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
ida = id2B
...
```{r Figure-ILB-2-1, fig.height = 5, fig.width = 10, fig.align = "center"}
library("wesanderson")
colr = wes_palette("Darjeeling1")
colr2 = colr[c(5,1)]
par(mfrow=c(1,2))
...
```{r Figure-ILB-2-2, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
...
```{r Figure-ILB-2-3, fig.height = 5, fig.width = 10, fig.align = "center"}
library(mgcv)
par(mfrow=c(1,2))
...
```{r Figure-ILB-2-4, fig.height = 5, fig.width = 10, fig.align = "center"}
library(mgcv)
...
```{r Figure-ILB-2-6-1, fig.height = 5, fig.width = 8, fig.align = "center"}
...
```{r Figure-ILB-2-6-2, fig.height = 5, fig.width = 8, fig.align = "center"}
plot(p_donnee, col = p_donnee@data$Mediane_cat, border = "black")
legend("topright", legend = legende, fill = palette, 
...
```{r Figure-ILB-2-6-3, fig.height = 5, fig.width = 8, fig.align = "center"}
plot(p_donnee, col = p_donnee@data$Mediane_cat, border = "black")
legend("topright", legend = legende, fill = palette, 
...
```{r Figure-ILB-2-6-4, fig.height = 5, fig.width = 8, fig.align = "center"}
plot(p_donnee, col = p_donnee@data$Mediane_cat, border = "black")
legend("topright", legend = legende, fill = palette, 
...
```{r Figure-ILB-1-2, fig.height = 5, fig.width = 10, fig.align = "center"}
...
```{r Figure-ILB-1-1, fig.height = 5, fig.width = 10, fig.align = "center"}
library(rpart)
...
```{r Figure-ILB-4-22, fig.height = 5, fig.width = 10, fig.align = "center"}
plot(dF,
...
```{r Figure-ILB-2-8, fig.height = 5, fig.width = 10, fig.align = "center"}
...
```{r Figure-ILB-4-3, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
...
```{r Figure-ILB-4-6, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
...
```{r  Figure-ILB-4-14, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
plot(vecu,vecv_y0_s0,ylim=c(0,max_y),col=colr2[2],type="l",axes=FALSE,
     xlab="Score s (p=0)",ylab="")
xi=which(vecu>=0.6)
...
```{r Figure-ILB-4-15, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
plot(vecu,vecv_y0_s0,ylim=c(0,max_y),col=colr2[2],type="l",axes=FALSE,
     xlab="Score s (p=0)",ylab="")
xi=which(vecu>=0.6)
...
```{r Figure-ILB-4-5, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
plot(vecu,vecv_y0_s0,ylim=c(0,max_y),col=colr2[2],type="l",axes=FALSE,
     xlab="Score s (p=0)",ylab="")
xi=which(vecu>=0.6)
...
```{r Figure-ILB-4-16, fig.height = 5, fig.width = 10, fig.align = "center"}
par(mfrow=c(1,2))
